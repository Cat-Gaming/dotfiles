...
globalkeys = gears.table.join(
    ...
    awful.util.spawn("pcmanfm") end,
              {description = "launches a file manager", group = "applications"}),
    
    -- File manager
    awful.key({ modkey },            "d",     function ()
        awful.util.spawn("discord") end,
                  {description = "launches discord", group = "applications"}),
...
awful.spawn.with_shell("nitrogen --restore") -- Desktop Background
